        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Connections_Classes_FK_ClassId",
                        column: x => x.FK_ClassId,
                        principalTable: "Classes",
                        principalColumn: "ClassID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Connections_Courses_FK_CourseId",
                        column: x => x.FK_CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Connections_Students_FK_StudentId",
                        column: x => x.FK_StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Connections_Teachers_FK_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Connections_FK_ClassId",
                table: "Connections",
                column: "FK_ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_Connections_FK_CourseId",
                table: "Connections",
                column: "FK_CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Connections_FK_StudentId",
                table: "Connections",
                column: "FK_StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Connections_FK_TeacherId",
                table: "Connections",
                column: "FK_TeacherId");
        }
